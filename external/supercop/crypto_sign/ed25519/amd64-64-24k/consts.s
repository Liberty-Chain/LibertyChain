#ifdef __APPLE__
  #define LIBERTY_LOCAL_SYMBOL(x) .private_extern x
#else
  #define LIBERTY_LOCAL_SYMBOL(x) .hidden x
#endif
...
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_121666)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU0)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU1)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU2)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU3)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU4)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER0)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER1)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER2)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER3)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D0)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D1)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D2)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D3)
LIBERTY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_38)
