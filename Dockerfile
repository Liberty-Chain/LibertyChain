...
# Create liberty user
RUN adduser --system --group --disabled-password liberty && \
	mkdir -p /wallet /home/liberty/.bitliberty && \
	chown -R liberty:liberty /home/liberty/.bitliberty && \
	chown -R liberty:liberty /wallet

# Contains the blockchain
VOLUME /home/liberty/.bitliberty
...
# switch to user liberty
USER liberty

ENTRYPOINT ["libertyd", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18080", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=48081", "--non-interactive", "--confirm-external-bind"]
